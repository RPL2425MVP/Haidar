...
<!-- Mirrored from codervent.com/onedash/demo/ltr/table-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 06:59:40 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
          ...
          <ul class="metismenu" id="menu">
            <li>
              <a href="javascript:;" class="has-arrow">
                ...
                <div class="menu-title">Pendahuluan</div>
              </a>
             <ul> 
             <li> <a href="?pages=definisi"> Pengenalan PHP</a>
             </li>
             <li> <a href="?pages=instalasi"> Instalsi XAMPP</a>
             </li>
             <li> <a href="?pages=skrip dasar"> Struktur Dasar</a>
             </li>
             <li> <a href="?pages=variabel"> Variabel</a>
             </li>
             <li> <a href="?pages=tipe data"> Tipe Data</a>
             </li>
             <li> <a href="?pages=Operator"> Operator</a>
             </li>
            </ul>
             ...
             <li>
              ...
              <ul>
                <li> <a href="?pages=sas"></i>SAS 1</a>
                </li>
              </ul>
              
              <ul>
                <li> <a href="?pages=obat"></i>Obat</a>
                </li>
              </ul>
              <ul>
                <li> <a href="?pages=kategori"></i>Kategori</a>
                </li>
              </ul>
              <ul>
                <li> <a href="?pages=suplier"></i>Suplier</a>
                </li>
              </ul>
            ...
            <li>
              ...
              <ul>
                <li> <a href="?pages=Tampil"><i class="bi bi-circle"></i>Barang</a>

                </li>
                
                <li> <a href="?pages=Tabel"><i class="bi bi-circle"></i>Siswa</a>
...
<!-- Mirrored from codervent.com/onedash/demo/ltr/table-datatable.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Feb 2025 06:59:43 GMT -->
</html>